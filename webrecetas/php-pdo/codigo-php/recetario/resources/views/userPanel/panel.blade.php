...
<div class="col-12 nomarpad" style="height:250px; background-color:#63A6A6">
    ...
    <div class="content">
        ...
        <div class="row nomarpad" style="justify-content: space-evenly">
            <div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 nomarpad mb-3 mr-1" style="align-self: center; text-align-last: center;border:5px dotted;min-height: 200px;display: flex;align-items: center;place-content: center;">
            ...
            <!--<div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 nomarpad mb-3 mr-1" style="border:5px dotted;min-height: 200px">
                <form method="POST" action="../myrecipe/{{$recipe->id}}">
                    <div class="row nomarpad">
                        @csrf
                            <a href="{{url('recipe/'.$recipe->id)}}" style="text-decoration:none;color:#000000">
